...
-- =============================================================================
CREATE TABLE IF NOT EXISTS h1b_lca_data (
...
CREATE INDEX IF NOT EXISTS idx_h1b_employer_name ON h1b_lca_data (employer_name);
CREATE INDEX IF NOT EXISTS idx_h1b_job_title ON h1b_lca_data (job_title);
CREATE INDEX IF NOT EXISTS idx_h1b_soc_code ON h1b_lca_data (soc_code);
CREATE INDEX IF NOT EXISTS idx_h1b_wage_from ON h1b_lca_data (wage_rate_of_pay_from);

-- =============================================================================
-- Drop legacy views (transition from views to pre-computed tables)
-- =============================================================================
DROP VIEW IF EXISTS h1b_lca_stats CASCADE;
DROP VIEW IF EXISTS h1b_distinct_employers CASCADE;
DROP VIEW IF EXISTS h1b_distinct_jobs CASCADE;
DROP VIEW IF EXISTS h1b_distinct_locations CASCADE;
DROP VIEW IF EXISTS h1b_state_stats CASCADE;

-- =============================================================================
-- DERIVED TABLE: Aggregate statistics (1 row)
-- Endpoint: GET /h1b_lca_stats
-- =============================================================================
CREATE TABLE IF NOT EXISTS h1b_lca_stats (
...
-- =============================================================================
CREATE TABLE IF NOT EXISTS h1b_distinct_employers (
  employer_name TEXT,
  filing_count BIGINT
);

CREATE INDEX IF NOT EXISTS idx_de_name ON h1b_distinct_employers USING gin (employer_name gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_de_count ON h1b_distinct_employers (filing_count DESC);

-- =============================================================================
-- DERIVED TABLE: Distinct job titles per employer
-- Endpoint: GET /h1b_distinct_jobs
-- =============================================================================
CREATE TABLE IF NOT EXISTS h1b_distinct_jobs (
  employer_name TEXT,
  job_title TEXT,
  filing_count BIGINT
);

CREATE INDEX IF NOT EXISTS idx_dj_emp ON h1b_distinct_jobs USING gin (employer_name gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_dj_title ON h1b_distinct_jobs USING gin (job_title gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_dj_count ON h1b_distinct_jobs (filing_count DESC);

-- =============================================================================
-- DERIVED TABLE: Distinct locations per employer
-- Endpoint: GET /h1b_distinct_locations
-- =============================================================================
CREATE TABLE IF NOT EXISTS h1b_distinct_locations (
  employer_name TEXT,
  worksite_address TEXT,
  filing_count BIGINT
);

CREATE INDEX IF NOT EXISTS idx_dl_emp ON h1b_distinct_locations USING gin (employer_name gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_dl_addr ON h1b_distinct_locations USING gin (worksite_address gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_dl_count ON h1b_distinct_locations (filing_count DESC);

-- =============================================================================
-- DERIVED TABLE: State-level aggregation (for the map dashboard)
-- Endpoint: GET /h1b_state_stats
-- =============================================================================
CREATE TABLE IF NOT EXISTS h1b_state_stats (
