...
-- =============================================================================
-- This script:
--   1. Loads h1b.csv into public.h1b_lca_data (source table)
...
\copy public.h1b_lca_data (sq_nm, job_title, soc_code, soc_title, employer_name, employer_address, worksite_address, wage_rate_of_pay_from, wage_rate_of_pay_to, prevailing_wage, pw_wage_level) FROM '/app/h1b.csv' WITH (FORMAT csv, HEADER true, NULL '');
