...
-- =============================================
TRUNCATE h1b_lca_data RESTART IDENTITY;

\copy h1b_lca_data (sq_nm, job_title, soc_code, soc_title, employer_name, employer_address, worksite_address, wage_rate_of_pay_from, wage_rate_of_pay_to, prevailing_wage, pw_wage_level) FROM '/app/h1b.csv' WITH (FORMAT csv, HEADER true, NULL '');

SELECT COUNT(*) as rows_loaded FROM h1b_lca_data;
...
TRUNCATE h1b_lca_stats;
INSERT INTO h1b_lca_stats
  SELECT
...
TRUNCATE h1b_distinct_employers;
INSERT INTO h1b_distinct_employers
...
TRUNCATE h1b_distinct_jobs;
INSERT INTO h1b_distinct_jobs
  SELECT UPPER(TRIM(employer_name)) as employer_name,
...
TRUNCATE h1b_distinct_locations;
INSERT INTO h1b_distinct_locations
  SELECT UPPER(TRIM(employer_name)) as employer_name,
...
TRUNCATE h1b_state_stats;
INSERT INTO h1b_state_stats
  WITH extracted AS (
    SELECT
...
-- STEP 3: Verify
-- =============================================
SELECT 'h1b_lca_data' as table_name, COUNT(*) as row_count FROM h1b_lca_data
UNION ALL
SELECT 'h1b_lca_stats', COUNT(*) FROM h1b_lca_stats
UNION ALL
SELECT 'h1b_distinct_employers', COUNT(*) FROM h1b_distinct_employers
UNION ALL
SELECT 'h1b_distinct_jobs', COUNT(*) FROM h1b_distinct_jobs
UNION ALL
SELECT 'h1b_distinct_locations', COUNT(*) FROM h1b_distinct_locations
UNION ALL
SELECT 'h1b_state_stats', COUNT(*) FROM h1b_state_stats;
